...
const RemoveCourse = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				let response = await axios.get("https://backendapp.up.railway.app/api/training/" + courseID, {
					headers: {
	...
	const handlesubmit = async (e) => {
		...
		try {
			const response = await axios.put(`https://backendapp.up.railway.app/api/training/update/${courseID}`, postData, {
				headers: {
					Authorization: `Bearer ${auth.Token}`,
					withCredentails: true,
				},
